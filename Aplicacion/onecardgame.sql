...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-05-2024 a las 22:20:58
...
('OP01-001', 'Roronoa Zoro', 'Leader Card', 'L', 0, 5, 'Slash', 0, 'Red', 'Supernovas', 'Straw Hat Crew', 'NULL', NULL, NULL),
('OP01-001AA', 'Roronoa Zoro', 'Leader Card', 'L', 0, 5, 'Slash', 0, 'Red', 'Supernovas', 'Straw Hat Crew', 'NULL', NULL, NULL),
('OP01-002', 'Trafalgar Law', 'Leader Card', 'L', 0, 5, 'Slash', 0, 'Red/Green', 'Supernovas', 'Heart Pirates', 'NULL', NULL, NULL),
('OP01-002AA', 'Trafalgar Law', 'Leader Card', 'L', 0, 5, 'Slash', 0, 'Red/Green', 'Supernovas', 'Heart Pirates', 'NULL', NULL, NULL),
('OP01-003', 'Monkey.D.Luffy', 'Leader Card', 'L', 0, 5, 'Strike', 0, 'Red/Green', 'Supernovas', 'Straw Hat Crew', 'NULL', NULL, NULL),
('OP01-003AA', 'Monkey.D.Luffy', 'Leader Card', 'L', 0, 5, 'Strike', 0, 'Red/Green', 'Supernovas', 'Straw Hat Crew', 'NULL', NULL, NULL),
...
('OP01-008AA', 'Cavendish', 'Character', 'C', 4, 5, 'Strike', 0, 'Red', 'Supernovas', 'Beautiful Pirates', 'NULL', NULL, NULL),
...
('OP01-013AA', 'Sanji', 'Character', 'R', 2, 3, 'Strike', 2000, 'Red', 'Straw Hat Crew', 'NULL', 'NULL', NULL, NULL),
...
('OP01-016AA', 'Nami', 'Character', 'R', 1, 2, 'Special', 1000, 'Red', 'Straw Hat Crew', 'NULL', 'NULL', NULL, NULL),
...
('OP01-024AA', 'Monkey.D.Luffy', 'Character', 'SR', 2, 3, 'Strike', 1000, 'Red', 'Supernovas', 'Straw Hat Crew', 'NULL', NULL, NULL),
('OP01-025', 'Roronoa Zoro', 'Character', 'SR', 3, 5, 'Slash', 0, 'Red', 'Supernovas', 'Straw Hat Crew', 'NULL', NULL, NULL),
('OP01-025AA', 'Roronoa Zoro', 'Character', 'SR', 3, 5, 'Slash', 0, 'Red', 'Supernovas', 'Straw Hat Crew', 'NULL', NULL, NULL),
...
('OP01-031', 'Kouzuki Oden', 'Leader Card', 'L', 0, 5, 'Slash', 0, 'Green', 'Land of Wano', 'Kouzuki Clan', 'NULL', NULL, NULL),
('OP01-031AA', 'Kouzuki Oden', 'Leader Card', 'L', 0, 5, 'Slash', 0, 'Green', 'Land of Wano', 'Kouzuki Clan', 'NULL', NULL, NULL),
...
('OP01-034AA', 'Inuarashi', 'Character', 'C', 3, 4, 'Slash', 1000, 'Green', 'Minks', 'Land of Wano', 'The Akazaya Nine', NULL, NULL),
...
('OP01-040AA', 'Kin\'emon', 'Character', 'SR', 6, 6, 'Slash', 0, 'Green', 'Land of Wano', 'The Akazaya Nine', 'NULL', NULL, NULL),
...
('OP01-047AA', 'Trafalgar Law', 'Character', 'SR', 5, 6, 'Slash', 0, 'Green', 'Supernovas', 'Heart Pirates', 'NULL', NULL, NULL),
('OP01-048', 'Nekomamushi', 'Character', 'C', 2, 3, 'Slash', 1000, 'Green', 'Minks', 'Land of Wano', 'The Akazaya Nine', NULL, NULL),
('OP01-048AA', 'Nekomamushi', 'Character', 'C', 2, 3, 'Slash', 1000, 'Green', 'Minks', 'Land of Wano', 'The Akazaya Nine', NULL, NULL),
...
('OP01-051AA', ' Eustass\"Captain\"Kid', 'Character', 'SR', 8, 8, 'Special', 0, 'Green', 'Supernovas', 'Kid Pirates', 'NULL', NULL, NULL),
...
('OP01-060', 'Donquixote Doflamingo', 'Leader Card', 'L', 0, 5, 'Special', 0, 'Blue', 'The Seven Warlords of the Sea', 'Donquixote Pirates', 'NULL', NULL, NULL),
('OP01-060AA', 'Donquixote Doflamingo', 'Leader Card', 'L', 0, 5, 'Special', 0, 'Blue', 'The Seven Warlords of the Sea', 'Donquixote Pirates', 'NULL', NULL, NULL),
('OP01-061', 'Kaido', 'Leader Card', 'L', 0, 5, 'Strike', 0, 'Purple/Blue', 'The Four Emperors', 'Animal Kingdom Pirates', 'NULL', NULL, NULL),
('OP01-061AA', 'Kaido', 'Leader Card', 'L', 0, 5, 'Strike', 0, 'Purple/Blue', 'The Four Emperors', 'Animal Kingdom Pirates', 'NULL', NULL, NULL),
('OP01-062', 'Crocodile', 'Leader Card', 'L', 0, 5, 'Special', 0, 'Purple/Blue', 'The Seven Warlords of the Sea', 'Baroque Works', 'NULL', NULL, NULL),
('OP01-062AA', 'Crocodile', 'Leader Card', 'L', 0, 5, 'Special', 0, 'Purple/Blue', 'The Seven Warlords of the Sea', 'Baroque Works', 'NULL', NULL, NULL),
...
('OP01-064AA', 'Alvida', 'Character', 'C', 2, 3, 'Strike', 2000, 'Blue', 'Buggy Pirates', 'NULL', 'NULL', NULL, NULL),
...
('OP01-067AA', 'Crocodile', 'Character', 'SR', 7, 7, 'Special', 1000, 'Blue', 'The Seven Warlords of the Sea', 'Baroque Works', 'NULL', NULL, NULL),
...
('OP01-070AA', 'Dracule Mihawk', 'Character', 'SR', 9, 9, 'Slash', 0, 'Blue', 'The Seven Warlords of the Sea', 'NULL', 'NULL', NULL, NULL),
...
('OP01-073AA', 'Donquixote Doflamingo', 'Character', 'R', 3, 4, 'Special', 1000, 'Blue', 'The Seven Warlords of the Sea', 'Donquixote Pirates', 'NULL', NULL, NULL),
...
('OP01-077AA', 'Perona', 'Character', 'UC', 1, 2, 'Special', 1000, 'Blue', 'Thriller Bark Pirates', 'NULL', 'NULL', NULL, NULL),
('OP01-078', 'Boa Hancock', 'Character', 'SR', 4, 5, 'Special', 1000, 'Blue', 'The Seven Warlords of the Sea', 'Kuja Pirates', 'NULL', NULL, NULL),
('OP01-078AA', 'Boa Hancock', 'Character', 'SR', 4, 5, 'Special', 1000, 'Blue', 'The Seven Warlords of the Sea', 'Kuja Pirates', 'NULL', NULL, NULL),
...
('OP01-091', 'King', 'Leader Card', 'L', 0, 5, 'Special', 0, 'Purple', 'Animal Kingdom Pirates', 'NULL', 'NULL', NULL, NULL),
('OP01-091AA', 'King', 'Leader Card', 'L', 0, 5, 'Special', 0, 'Purple', 'Animal Kingdom Pirates', 'NULL', 'NULL', NULL, NULL),
...
('OP01-093AA', 'Ulti', 'Character', 'R', 2, 3, 'Strike', 0, 'Purple', 'Animal Kingdom Pirates', 'NULL', 'NULL', NULL, NULL),
('OP01-094', 'Kaido', 'Character', 'SR', 10, 12, 'Strike', 0, 'Purple', 'The Four Emperors', 'Animal Kingdom Pirates', 'NULL', NULL, NULL),
('OP01-094AA', 'Kaido', 'Character', 'SR', 10, 12, 'Strike', 0, 'Purple', 'The Four Emperors', 'Animal Kingdom Pirates', 'NULL', NULL, NULL),
...
('OP01-096AA', 'King', 'Character', 'SR', 7, 7, 'Special', 0, 'Purple', 'Animal Kingdom Pirates', 'NULL', 'NULL', NULL, NULL),
('OP01-097', 'Queen', 'Character', 'R', 6, 5, 'Strike', 1000, 'Purple', 'Animal Kingdom Pirates', 'NULL', 'NULL', NULL, NULL),
('OP01-097AA', 'Queen', 'Character', 'R', 6, 5, 'Strike', 1000, 'Purple', 'Animal Kingdom Pirates', 'NULL', 'NULL', NULL, NULL),
...
('OP01-102AA', 'Jack', 'Character', 'R', 3, 4, 'Strike', 1000, 'Purple', 'Animal Kingdom Pirates', 'NULL', 'NULL', NULL, NULL),
...
('OP01-109AA', 'Who\'s.Who', 'Character', 'UC', 2, 3, 'Slash', 1000, 'Purple', 'Animal Kingdom Pirates', 'NULL', 'NULL', NULL, NULL),
...
('OP01-120AA', 'Shanks', 'Character', 'SCR', 9, 10, 'Slash', 0, 'Red', 'The Four Emperors', 'Red-Haired Pirates', 'NULL', NULL, NULL),
('OP01-120AAM', 'Shanks (Manga)', 'Character', 'SCR', 9, 10, 'Slash', 0, 'Red', 'The Four Emperors', 'Red-Haired Pirates', 'NULL', NULL, NULL),
('OP01-121', 'Yamato', 'Character', 'SCR', 5, 5, 'Strike', 1000, 'Green', 'Land of Wano', 'NULL', 'NULL', NULL, NULL),
('OP01-121AA', 'Yamato', 'Character', 'SCR', 5, 5, 'Strike', 1000, 'Green', 'Land of Wano', 'NULL', 'NULL', NULL, NULL),
('OP01-DONAA', 'Your Turn +1000', 'Don', 'NULL', 0, 0, 'NULL', 0, 'NULL', 'NULL', 'NULL', 'NULL', NULL, NULL);
...
--
-- Estructura de tabla para la tabla `deck_card`
--
...
--
-- Volcado de datos para la tabla `deck_card`
--

INSERT INTO `deck_card` (`id`, `deck_id`, `card_id`) VALUES
(1, 1, 'OP01-001'),
(2, 1, 'OP01-004'),
(3, 1, 'OP01-004'),
(4, 1, 'OP01-004'),
...
--
-- AUTO_INCREMENT de la tabla `deck_card`
--
ALTER TABLE `deck_card`
...
--
-- Filtros para la tabla `deck_card`
--
ALTER TABLE `deck_card`
  ADD CONSTRAINT `deck_card_ibfk_1` FOREIGN KEY (`deck_id`) REFERENCES `deck` (`id`),
  ADD CONSTRAINT `deck_card_ibfk_2` FOREIGN KEY (`card_id`) REFERENCES `card` (`id`);
